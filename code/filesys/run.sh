...
echo './filesys/nachos -cp userland/echo userland/echo -ls'
./filesys/nachos -cp userland/echo userland/echo -ls
echo './filesys/nachos -cp userland/exec userland/exec -ls'
./filesys/nachos -cp userland/exec userland/exec -ls
echo './filesys/nachos -cp userland/filetest userland/filetest -ls'
./filesys/nachos -cp userland/filetest userland/filetest -ls
echo './filesys/nachos -cp userland/halt userland/halt -ls'
./filesys/nachos -cp userland/halt userland/halt -ls
echo './filesys/nachos -cp userland/matmult userland/matmult -ls'
./filesys/nachos -cp userland/matmult userland/matmult -ls
echo './filesys/nachos -cp userland/min userland/min -ls'
./filesys/nachos -cp userland/min userland/min -ls
echo './filesys/nachos -cp userland/shell userland/shell -ls'
./filesys/nachos -cp userland/shell userland/shell -ls
echo './filesys/nachos -cp userland/sort userland/sort -ls'
./filesys/nachos -cp userland/sort userland/sort -ls
